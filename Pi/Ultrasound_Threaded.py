##A multithreaded implementation of the Read_Sensors script (simultaneous reading)
##Imports
...
##Default global values to be used for sensor readings
ultra_left = 0
ultra_right = 0
lidar = 0

#W#rite the command to the serial bus to activate Lidar sensor
